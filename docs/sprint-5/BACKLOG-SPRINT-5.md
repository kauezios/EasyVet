...
| EV-S5-003 | Tendencia semanal de no-show e cancelamento | Backend + Frontend | Media | 5 pts | Concluido | Sistema exibe evolucao semanal consolidada para suporte de acao gerencial |
| EV-S5-004 | Alertas de retorno abaixo da meta operacional | Frontend | Media | 5 pts | Concluido | Painel destaca quando taxa de retorno ficar abaixo do limite configurado |
